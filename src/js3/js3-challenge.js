...
calcTVHeight = function() {} Given a width on a 16:9 tv, calculate the height
...
exports.minDateableAge = function() {
  return 0; // change this line and add others if needed
};

exports.hasFever = function() {
  return true; // change this line and add others if needed
};

exports.calcTVHeight = function() {
  return true; // change this line and add others if needed
};

exports.couldDate = function() {
  return true; // change this line and add others if needed
